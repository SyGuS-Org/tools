...
namespace SynthLib2Parser {
    ...
    class SynthInvCmd : public ASTCmd
    {
    private:
        string SynthInvName;
        ArgList Arguments;
    ...
    public:
        ...
        // accessors
        const string& GetSynthInvName() const;
        const string& GetPreCondName() const;
        const string& GetTransName() const;
        const string& GetPostCondName() const;
    ...
    public:
        ...
        // accessors
        const string& GetName() const;
        const string& GetPrimedName() const;
        const SortExpr* GetSort() const;
    };
    ...
    public:
	  ...
	  case SORTKIND_BV:
	    return "SORTKIND_BV";
	  case SORTKIND_ARRAY:
	    return "SORTKIND_ARRAY";
	  case SORTKIND_REAL:
	    return "SORTKIND_REAL";
	  case SORTKIND_BOOL:
	    return "SORTKIND_BOOL";
	  case SORTKIND_FUN:
	    return "SORTKIND_FUN";
	  case SORTKIND_ENUM:
	    return "SORTKIND_ENUM";
	  case SORTKIND_NAMED:
	    return "SORTKIND_NAMED";
          case SORTKIND_STRING:
	    return "SORTKIND_STRING";
	  }
	  return "";
	}
    };
    ...
    class StringSortExpr : public SortExpr
    {
    public:
        StringSortExpr(const SourceLocation& Location);
        StringSortExpr();
        virtual ~StringSortExpr();
    ...
    public:
        ...
        virtual void VisitStringSortExpr(const StringSortExpr* Sort);  
    ...
    public:
        SynthLib2Parser();
        SynthLib2Parser(SymbolTable* SymTbl);
        ~SynthLib2Parser();
