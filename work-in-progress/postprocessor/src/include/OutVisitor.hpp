#if !defined __SYNTHLIB2_PARSER_OUT_VISITOR_HPP
#define __SYNTHLIB2_PARSER_OUT_VISITOR_HPP
...
namespace SynthLib2Parser {
    ...
    class OutVisitor : public ASTVisitorBase
    {
    private:
        u32 IndentLevel;
        ...
        vector<const FunDefCmd*> FunDefs;

    public:
      OutVisitor(ostream& Out, const SymbolTable* = NULL);
      virtual ~OutVisitor();

      vector<const FunDefCmd*>&  GetFunDefs() { return FunDefs; }
...
#endif /* __SYNTHLIB2_PARSER_OUT_VISITOR_HPP */
